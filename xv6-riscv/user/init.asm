...
free(void *ap)
{
 ...
 732:	20a7b783          	ld	a5,522(a5) # 938 <__SDATA_BEGIN__>
 ...
 760:	00e6ea63          	bltu	a3,a4,774 <free+0x50>
{
 ...
 7a2:	18f73d23          	sd	a5,410(a4) # 938 <__SDATA_BEGIN__>
}
 7a6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d4:	16853503          	ld	a0,360(a0) # 938 <__SDATA_BEGIN__>
 ...
 7fc:	14090913          	addi	s2,s2,320 # 938 <__SDATA_BEGIN__>
  if(p == (char*)-1)
 800:	5afd                	li	s5,-1
 ...
 810:	12f73623          	sd	a5,300(a4) # 938 <__SDATA_BEGIN__>
 814:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 836:	10a73323          	sd	a0,262(a4) # 938 <__SDATA_BEGIN__>
      return (void*)(p + 1);
